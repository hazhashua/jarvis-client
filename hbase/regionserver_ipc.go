...
//
//    regionserverIPC, err := UnmarshalRegionserverIPC(bytes)
//    bytes, err = regionserverIPC.Marshal()

package hbase

import "encoding/json"

func UnmarshalRegionserverIPC(data []byte) (RegionserverIPC, error) {
	var r RegionserverIPC
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *RegionserverIPC) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type RegionserverIPC struct {
	Beans []RegionIPCBean `json:"beans,omitempty"`
}

type RegionIPCBean struct {
