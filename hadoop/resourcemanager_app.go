...
type QueueBean struct {
	...
	AbsoluteUsedCapacity                           *int64  `json:"AbsoluteUsedCapacity,omitempty"`
	...
	AppAttemptFirstContainerAllocationDelayAvgTime *int64  `json:"AppAttemptFirstContainerAllocationDelayAvgTime,omitempty"`
